# Code of Conduct - reachy-mini-cam-relay Project

## Our Pledge

We pledge to make the **reachy-mini-cam-relay** project a welcoming, safe, and equitable space for all contributors and users.
...
As part of the development, documentation, research, and dissemination of results related to **reachy-mini-cam-relay**, we strive to:

1. **Respect the purpose of the project**, its activities, and its technical community.
